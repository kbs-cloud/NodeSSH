...
export const KeyImportModal: React.FC = () => {
  ...
  return (
    <Modal
      ...
      onClose={() => setIsKeyImportOpen(false)}
      ...
      <form onSubmit={handleSave} className="space-y-4 text-xs text-slate-200">
        ...
        <div className="p-4 rounded-lg border-2 border-dashed border-white/10 hover:border-cyan-400/50 bg-[#070913] text-center transition-colors">
          ...
          >
            ...
            <span className="font-semibold text-white">Click or drag private key file here (.pem, .ppk, OpenSSH)</span>
